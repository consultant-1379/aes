...
main (int ac, char **av)
{
	...
	runner.addTest ("afpdef", AfpdefTestCase::suite() );
	runner.addTest ("afpchd", AfpchdTestCase::suite() );
	runner.addTest ("afpfti", AfpftiTestCase::suite() );
	runner.addTest ("afprm",  AfprmTestCase::suite()  );
	runner.addTest ("afpfte", AfpfteTestCase::suite() );
  runner.run (ac, av);
  return 0;
}
