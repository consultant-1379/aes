// aes_afp_api_r3.h: interface for the aes_afp_api_r3 class.
//
//////////////////////////////////////////////////////////////////////

//#if !defined(AFX_AES_AFP_API_R3_H__BD112FFD_3697_4AD0_955C_F2F10201960C__INCLUDED_)
//#define AFX_AES_AFP_API_R3_H__BD112FFD_3697_4AD0_955C_F2F10201960C__INCLUDED_
...
//public:
//	aes_afp_api_r3();
//	virtual ~aes_afp_api_r3();

//};

//#endif // !defined(AFX_AES_AFP_API_R3_H__BD112FFD_3697_4AD0_955C_F2F10201960C__INCLUDED_)

// uabmha: CNI 1135; Generated stuff by Visual Studio above, copied and updated r2 below
...
//## Source file: Z:\ntaes\afp\afpapilib_cxa\inc\aes_afp_api_r3.h

#ifndef aes_afp_api_r3_h
#define aes_afp_api_r3_h 1
...
//## Uses: <unnamed>%3EACEE9E03D1;string { -> }
//## Uses: <unnamed>%3EACEEA30157;strstream { -> }
//## Uses: <unnamed>%3EACEEA901D8;AES_GCC_Eventcodes { -> }
//## Uses: <unnamed>%3EACEEBC037A;AES_GCC_Format { -> }
//## Uses: <unnamed>%3EACEEBF0270;list { -> }
//## Uses: <unnamed>%3EACEEC70376;AES_GCC_Errorcodes { -> }
//## Uses: <unnamed>%3EACEECB02EF;AES_GCC_Filestates { -> }
//## Uses: <unnamed>%3EACEECF020F;AES_AFP_Proctype { -> }
//## Uses: <unnamed>%3EACEED302E7;AES_AFP_Renametypes { -> }
//## Uses: <unnamed>%3EAD21470285;aes_afp_apiinternal { -> F}
...
// uabmha: CNI 1135, new stuff added below for r3, (new createTransferQueue call)
// 

//## begin aes_afp_api_r3%3EACEE03032E.preface preserve=yes
//## end aes_afp_api_r3%3EACEE03032E.preface

//## Class: aes_afp_api_r3%3EACEE03032E
//	Interface class for AFP API.
//	Trace points: no
//## Category: afpapilib_cxa (CXA 110 1179)%387C517E0392
//## Subsystem: AFP::afpapilib_cxa::inc%387C52560099
...
class aes_afp_api_r3
{
  //## begin aes_afp_api_r3%3EACEE03032E.initialDeclarations preserve=yes
  //## end aes_afp_api_r3%3EACEE03032E.initialDeclarations
  ...
  public:
    ...
    //## Other Operations (specified)
      ...
      //## Operation: createTransferQueue%3EACEE3C03D0; C++
      //	Creates a new transfer queue entry in the database.
      unsigned int createTransferQueue (std::string& transferQueue, std::string& destinationSet, std::string sourceDirectory = "", AES_GCC_Filestates defaultState = AES_FSREADY, int removeDelay = 10, bool removeBefore = false, int retryTimeInterval = 10, int retryTimes = -1, AES_AFP_Renametypes renameFile = AES_NONE, std::string fileTemplate = "", std::string userGroup = "", std::string nameTag = "", int startupSequenceNumber = -1, bool treatAsDefaultValue = true);
    ...
    // Additional Public Declarations
      //## begin aes_afp_api_r3%3EACEE03032E.public preserve=yes
      //## end aes_afp_api_r3%3EACEE03032E.public

  protected:
    // Additional Protected Declarations
      //## begin aes_afp_api_r3%3EACEE03032E.protected preserve=yes
      //## end aes_afp_api_r3%3EACEE03032E.protected

  private:
    // Additional Private Declarations
      //## begin aes_afp_api_r3%3EACEE03032E.private preserve=yes
      //## end aes_afp_api_r3%3EACEE03032E.private
  ...
  private: //## implementation
    // Data Members for Class Attributes
      ...
      //## Attribute: internal%3EACEE4F0215
      //	Pointer to internal api class.
      //## begin aes_afp_api_r3::internal%3EACEE4F0215.attr preserve=no  private: aes_afp_apiinternal* {U} NULL
      aes_afp_apiinternal* internal_;
      //## end aes_afp_api_r3::internal%3EACEE4F0215.attr

    // Additional Implementation Declarations
      //## begin aes_afp_api_r3%3EACEE03032E.implementation preserve=yes
      //## end aes_afp_api_r3%3EACEE03032E.implementation

};

//## begin aes_afp_api_r3%3EACEE03032E.postscript preserve=yes
//## end aes_afp_api_r3%3EACEE03032E.postscript
