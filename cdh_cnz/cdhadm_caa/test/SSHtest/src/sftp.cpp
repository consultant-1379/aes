...
int main()
		{
			...
			cout<<"Test7: create a new directory with no permissions for parent directory"<< endl;
			if(sftpAdp->sftpCreateDirectories("/opt/ap/SFTP_TEST/NOPERM/NEWDIRCREATE")==true)
				cout<<"created the directory: /opt/ap/SFTP_TEST/NOPERM/NEWDIRCREATE"<<endl;
			else
				cout<<"Not created the directory: /opt/ap/SFTP_TEST/NOPERM/NEWDIRCREATE"<<endl;
			...
			if(sftpAdp->renameRemoteDir("/opt/ap/SFTP_TEST/NOPERM","/opt/ap/SFTP_TEST/NOPERMRENAMED")==true)
				cout<<"Renamed the directory to: /opt/ap/SFTP_TEST/NOPERMRENAMED"<<endl;
			else
				cout<<"Did not rename the directory to: /opt/ap/SFTP_TEST/NOPERMRENAMED"<<endl;
			...
			if(sftpAdp->sftpDeleteFile("/opt/ap/SFTP_TEST/NOPERM/NOPERMRENAMED")==true)
				cout<<"Deleted the File: /opt/ap/SFTP_TEST/NOPERM/NOPERMRENAMED"<<endl;
			else
				cout<<"Did not Delete the File: /opt/ap/SFTP_TEST/NOPERM/NOPERMRENAMED"<<endl;
			...
			if(sftpAdp->isRemoteFile("/opt/ap/SFTP_TEST/NOPERM/nopermfile")==true)
				cout<<"isRemoteFile: /opt/ap/SFTP_TEST/NOPERM/nopermfile"<<endl;
			else
				cout<<"IS not a RemoteFile: /opt/ap/SFTP_TEST/NOPERM/nopermfile"<<endl;
			...
			if(sdurgaftpAdp->isRemoteDir("/opt/ap/SFTP_TEST/NOPERM")==true)
			...
			if(sftpAdp->sftpSendFile("/opt/ap/SFTPTEST/SENDFILE/","noveride", "/opt/ap/SFTP_TEST", "RECVD",0,0)==true)
				cout<<"sftpSendFile sucess "<<endl;
			else
				cout<<"sftpSendFile not success"<<endl;
			...
			if(sftpAdp->sftpSendDir("/opt/SFTP/ap/SFTP2 ","SFTP2", "/opt/ap/SFTP_TEST", "RECVD")==true)
			...
			//	sftpAdp.sftpSendFile("/opt/ap/durga1/temp1", "durgatransfer", "/opt/ap/durga2", "temp11");
			//sftpAdp.renameRemoteFile("/opt/ap/durga2/temp11/durgatransfer", "/opt/ap/durga2/temp11/durgarenamed");
			//sftpAdp.renameRemoteDir("/opt/ap/durga2/temp11", "/opt/ap/durga2/durgarenamedDIR");
			//	if (sftpAdp.isRemoteDir("/opt/ap/durga2/durgarenamedDIR"))
			//		cout<< "/opt/ap/durga2/durgarenamedDIR is found in isremoteDir function"<<endl;
			//	if (sftpAdp.isRemoteFile("/opt/ap/durga2/durgarenamedDIR/durgarenamed"))
			//	cout<< "/opt/ap/durga2/durgarenamedDIR/durgarenamed is found in  isremoteDir function"<<endl;

			//	if(sftpAdp.sftpDeleteFile("/opt/ap/durga2/durgarenamedDIR"))
			//		cout<<"/opt/ap/durga2/durgarenamedDIR successfully deleted directory"<<endl;

			//	if (sftpAdp.sftpDeleteFile("/opt/ap/durga2/durgarenamedDIR/durgarenamed"))
			//		cout<<"/opt/ap/durga2/durgarenamedDIR/durgarenamed successfully deleted file"<<endl;

			//	if(sftpAdp.sftpDeleteFile("/opt/ap/durga2/durgarenamedDIR"))
			//	cout<<"/opt/ap/durga2/durgarenamedDIR successfully deleted directory"<<endl;
			//	cout<<" Going into sftpSendDir successfull..y"<<endl;
			//if(sftpAdp.sftpSendDir("/opt/ap/SFTP","/opt/ap/SFTP1/SFTP2/", "/opt/ap/SFTP1","/opt/ap/SFTP1/SFTP2"))
			//			cout<<" sftpSendDir successfull..y"<<endl;
			...
			if(sftpAdp->sftpCreateDirectories("/opt/ap/SFTP_TEST")==true)
				durga	cout<<"created the directory: /opt/ap/SFTP_TEST"<<endl;
			else
				cout<<"Not created the directory: /opt/ap/SFTP_TEST"<<endl;
			...
			cout<<"Test: create a new directory "<< endl;
			if(sftpAdp->sftpCreateDirectories("/opt/ap/SFTP_TEST/durga")==true)
				cout<<"created the directory: /opt/ap/SFTP_TEST/durga"<<endl;
			else
