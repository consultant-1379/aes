...
public:
	...
	ACE_Recursive_Thread_Mutex connectMutex;
	/*=================================================================== */
	/**
...
protected:
	...
	/*=================================================================== */
	/**
			      @brief   remoteFileList
						   -
	 */
	/*=================================================================== */
	std::list<string> remoteFileList;
	/*=================================================================== */
	/**
			      @brief   remoteFileListIter
						   -
	 */
	/*=================================================================== */
	std::list<string>::iterator remoteFileListIter;
	/*=================================================================== */
	/**
			      @brief   listTime
						   -
	...
	virtual void ftpDisconnect(void) throw() = 0;

	virtual AES_CDH_ResultCode verifyConnection() = 0;
	...
	virtual void ftpCreateDirectory(const std::string& name ) throw (AES_CDH_ResultCode) = 0;
	...
	/**
					    	      ...
					    	      @return          AES_CDH_ResultCode    indicates the status of doSendDirInitiating

					    	      @exception       none
	 */
	/*=================================================================== */
	/*virtual AES_CDH_ResultCode doSendDirInitiating(string path,
			AES_CDH_DestinationSet::transferMode trMode,
			const string fileMask) = 0;
	*/
	/*=====================================================================
