/*=================================================================== */
/**
   @file  aes_cdh_block_destset_handler.h 

   @brief Header file for CDH module.

          This module contains all the declarations useful to
          specify the class AES_CDH_BlockDestSetCmdHandler.
...
==================================================================== */
#ifndef AES_CDH_BLOCK_DESTSET_HANDLER_H
#define AES_CDH_BLOCK_DESTSET_HANDLER_H
...
==================================================================== */
using namespace std;
#define AES_CDH_BLOCK_DESTSET_IMPLEMENTER       "BlockDestinationSetImpl"
#define AES_CDH_BLOCK_DESTSET_CLASSNAME         "AxeDataTransferBlockDestinationSet"
#define AES_CDH_BLOCK_ACTIVE_DEST_DESTSET	"blockActiveDestination"
#define AES_CDH_BLOCK_DESTSET_RDN       	"blockDestinationSetId"
...
/**
 * @brief AES_CDH_BlockDestSetCmdHandler
 * AES_CDH_BlockDestSetCmdHandler class is extended from acs_apgcc_objectImplementereventhandler_V3.
 * It is having functions to handle IMM callbacks
 *
 *
 */
class AES_CDH_BlockDestSetCmdHandler:public acs_apgcc_objectimplementereventhandler_V3,public ACE_Task_Base
{
public:
	/**
	 * @brief
	 ...
	 */
	AES_CDH_BlockDestSetCmdHandler(string className,string szimpName, ACE_Thread_Manager* threadManager_);
   /**
   	* @brief
   	* destructor
   	*/
	~AES_CDH_BlockDestSetCmdHandler();
	/**
