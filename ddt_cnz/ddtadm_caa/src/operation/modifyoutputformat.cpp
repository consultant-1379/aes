...
AES_DDT_TRACE_DEFINE(AES_DDT_Operation_ModifyOutputFormat)

namespace operation {

	ModifyOutputFormat::ModifyOutputFormat()
	: OperationBase(OUTPUTFORMAT_MOD)
	{
	...
	void ModifyOutputFormat::setOperationDetails(const void* op_details)
	{
