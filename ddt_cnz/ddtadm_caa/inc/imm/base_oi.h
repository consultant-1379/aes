...
//
//	********************************************************
#ifndef DDTADM_CAA_INC_AES_DDT_IMM_BASE_OI_H_
#define DDTADM_CAA_INC_AES_DDT_IMM_BASE_OI_H_
...
namespace imm
{
	...
	class Base_OI : public ACE_Event_Handler, public acs_apgcc_objectimplementerinterface_V3, private boost::noncopyable
	{
 	public:
		...
		/** @brief isImmRegistered method
		 *
		 *	This method checks imm registration is done or not.
		 *
		...
		/** @brief setImmRegistration method
		 *
		 *	This method sets m_immRegistered flag to true.
		 *
		 *  @return none
		 *
		 *  @remarks Remarks
		...
		/** @brief setImmRegistration method
		 *
		 *	This method sets m_immRegistered flag to false.
		 *
		 *  @return none
		 *
		 *  @remarks Remarks
		...
		/** @brief isReatorRegistered method
		 *
		 *	This method checks reactor registration is done or not.
		 *
		 *  @return true on Success, otherwise false
		 *
		 *  @remarks Remarks
		...
		/** @brief setReactorRegistration method
		 *
		 *	This method sets m_reactorRegistered flag to true.
		 *
		 *  @return none
		 *
		 *  @remarks Remarks
		...
		/** @brief unsetReactorRegistration method
		 *
		 *	This method sets m_reactorRegistered flag to false.
		 *
		 *  @return none
		 *
		 *  @remarks Remarks
 	...
 	protected:
		...
		/** @brief sendRequestAndWaitResult method
		 *
		 *	This method sends the request and wait for the result.
		 *
		 *	@param id : operation identifier.
		 *
		 *	@param op_info : operation details.
		 *
		 *	@param reportErrorToImm : operation result.
		 *
		 *	@return true on Success, otherwise false
		 *
		 *	@remarks Remarks
...
#endif /* DDTADM_CAA_INC_AES_DDT_IMM_BASE_OI_H_ */
