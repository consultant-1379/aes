...
#ifndef DDTADM_CAA_INC_AES_DDT_MODIFYDATASOURCE_H_
#define DDTADM_CAA_INC_AES_DDT_MODIFYDATASOURCE_H_
...
namespace operation
{
	 ...
	 * @sa OperationBase
	 */
	class ModifyDataSource : public OperationBase
	{
	 public:
...
#endif /* DDTADM_CAA_INC_AES_DDT_MODIFYDATASOURCE_H_ */
