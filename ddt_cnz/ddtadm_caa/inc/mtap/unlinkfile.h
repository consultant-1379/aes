...
//
//	********************************************************
#ifndef DDTADM_CAA_INC_AES_DDT_MTAP_UNLINKFILE_H_
#define DDTADM_CAA_INC_AES_DDT_MTAP_UNLINKFILE_H_
...
namespace mtap
{
	...
	class UnlinkFile: public PDU
	{
	 public:

		//Constructor
		UnlinkFile(unsigned char* rawBuffer, const ssize_t& bufferSize);
		...
		/**
		 * @brief
		 * This method is called to parse the UNLINK_FILE PDU.
		 *
		 * @return NONE
		 *
		 */
		...
		/**
		 * @brief
		 * This method is called to create the response for the UNLINK_FILE PDU parsed.
		 *
