...
#ifndef DDTADM_CAA_INC_ALARM_ALARM_H_
#define DDTADM_CAA_INC_ALARM_ALARM_H_
#include <string>
#include <stdint.h>
...
public:
	...
	{
		UNKNOWN = 0,	/*!< UNKNOWN */
		CONNECTION_FAULT,	/*!< CONNECTION FAULT */
		DATASOURCE_WARNING	/*!< DATASOURCE WARNING */
	};
...
#endif /* DDTADM_CAA_INC_ALARM_ALARM_H_ */
